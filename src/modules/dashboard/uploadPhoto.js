    ...
    <div >
      <Dialog classes={{ paper: classes.paper }} open>
        ...
        <DialogContent classes={{ root: classes.root }}>
          ...
          {props.file?.previewURL ? (
            ...
            <input {...getInputProps()}/>
              ...
              <ImageTag
                    ...
                    src={props.ImageURL || "/images/upload.svg"} alt="logo_image"
                  />
              {/* <div>
                <label className={classes.styleUploadBtn} for="upload-file">
                  <img
                ...
                <p className={classes.styleParagraph}>
          ...
          <Row>
            <SubmitButton type="submit" style={{ cursor: "pointer" }} onClick={props.savePicture}>
              Use Photo
            </SubmitButton>
            <CancelButton type="submit" style={{ cursor: "pointer" }} onClick={props.clicked}>
              Cancel
            </CancelButton>
          </Row>
        </DialogContent>
