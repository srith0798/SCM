...
function SubscriptionTypeComponent(props) {
  return (
    <div className="p-3 cursor-pointer fc-dark-slate-blue text-center m-3 w-250 bg-white b-1-white subscription-plan-card-shadow z-index-100 br-4">
      <div className="fs-20 font-weight-bold">Loan Seller</div>
      <div className="fs-15 my-3">
        Create, transfer, sell and publish Loan Data Records on Blockchain
      </div>
      <img />
...
function SignUpForm(props) {
  ...
  return (
    <Column
      className="w-450 pl-5 ml-3 border-left py-3 my-3 align-items-center fc-dark-slate-blue"
      horizontal={"center"}
    >
      <form onSubmit={onLoginClicked} className="w-100">
        <label className="text-left w-100 fs-20">
          <span className="font-weight-bold">Create your account</span> (all
          field required)
        </label>
        ...
        <CustomInput
          ...
          onChange={onChangeEvent}
          error={state ? state.confirmPasswordError : ""}
          className="fs-15 p-2 mt-1"
        />
        ...
        <div className="w-100 text-left fs-15 my-1">
          By clicking on continue, you agree to the LIMB CRE
...
function SelectedSubscriptionComponent(props) {
  return (
    <div className="p-3 mx-3 cursor-pointer fc-dark-slate-blue text-center m-3 w-250 bg-white">
      <div className="fs-20 font-weight-bold">Loan Seller</div>
      <div className="fs-15 my-3">
        Create, transfer, sell and publish Loan Data Records on Blockchain
      </div>
...
function HeaderComponent(props) {
  return (
    <Row vertical="center" className="justify-content-between w-100">
      <img alt="" src="/images/limb_logo.svg" alt="limb" className="w-150" />
      <Row vertical="center">
